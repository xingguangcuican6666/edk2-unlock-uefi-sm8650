...
ifeq ($(TARGET_HIBERNATION_TZ_ENCRYPTION),true)
	HIBERNATION_TZ_ENCRYPTION := HIBERNATION_TZ_ENCRYPTION=1
else
	HIBERNATION_TZ_ENCRYPTION := HIBERNATION_TZ_ENCRYPTION=0
endif

ifeq ($(TARGET_DDR_SUPPORTS_SCT_CONFIG),true)
	DDR_SUPPORTS_SCT_CONFIG := DDR_SUPPORTS_SCT_CONFIG=1
else
	DDR_SUPPORTS_SCT_CONFIG := DDR_SUPPORTS_SCT_CONFIG=0
endif

ifeq ($(TARGET_APPEND_RAM_PARTITIONS_TO_MEM_NODE),true)
	APPEND_RAM_PARTITIONS_TO_MEM_NODE := APPEND_RAM_PARTITIONS_TO_MEM_NODE=1
else
	APPEND_RAM_PARTITIONS_TO_MEM_NODE := APPEND_RAM_PARTITIONS_TO_MEM_NODE=0
endif
